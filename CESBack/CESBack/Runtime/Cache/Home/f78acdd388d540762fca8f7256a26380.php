...
<!-- 边栏 -->
    ...
    <section id="main-content">
        ...
        <!-- 主容器  -->
        <section class="wrapper" id="container_data">
            ...
            <div class="row">
                <div class="panel-body" style="padding-bottom:0px;">
                    <div class="panel panel-primary">
                        ...
                        <textarea id="survey_content" rows="3" class="form-control"
                                  style="visibility:hidden"><?php echo ($content); ?></textarea>

                        <div style="margin:0 auto;text-align:center;">
                            <div><span>扫描下方二维码可将该问卷结果分享给指定用户</span></div>
                            <img src="<?php echo ($src_url); ?>">

                            <div><span>或分享下方链接进行查看</span></div>
                            <span><?php echo ($pc_url); ?></span>

                            <div><span>也可通过数据管理模块导出该问卷Excel进行分享或向用户微信发送二维码</span></div>
                        </div>



                        <textarea id="survey_name" rows="3" class="form-control"
                                  style="visibility:hidden"><?php echo ($name); ?></textarea>
                    </div>
                </div>
            </div>
...
<script src="/CESBack/Public/js/dataManage/surveyCountStart.js" type="text/javascript"></script>
