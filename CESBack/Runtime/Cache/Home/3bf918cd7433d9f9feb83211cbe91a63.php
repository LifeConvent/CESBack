...
<head>
    ...
    <link href="/CESBack/Public/assets/icheck/green.css" rel="stylesheet">
</head>
<script type="text/javascript">
    var HOST = "http://x9v8ac.natappfree.cc/";
    var KEY = "Ia0CtpywryfU5VGNAlk23s8ctM-99v7we2HZmkVuh_szDz3dinL9aQ9gqslBTZk2";
</script>
<body>
<!-- SECTION -->
<section id="container">
    ...
    <section id="main-content" class="wrapper">
        ...
        <div class="row">
            <div class="panel-body">
                <div class="panel panel-primary">
                    <div class="panel-heading color-hui" style="text-align:center;"><span id="s_name">1</span></div>
                    <div class="panel-body">
                        <div>
        ...
        <!--测试用文本框-->
        <textarea rows="8" id="QList" class="form-control" style="display:none"><?php echo ($QList); ?></textarea>
        <textarea rows="8" id="SList" class="form-control" style="display:none"><?php echo ($SList); ?></textarea>
        <textarea rows="8" id="S_openid" class="form-control" style="display:none"><?php echo ($openid); ?></textarea>
        <input type="text" id="q_count" class="form-control" style="display:none" value="0">
        <input type="text" id="survey_id" class="form-control" style="display:none" value="0">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-warning" type="button" onclick="">确认</button>
                    </div>
                </div>
            </div>
...
<script src="/CESBack/Public/assets/icheck/icheck.js"></script>
<script src="/CESBack/Public/js/md5.js" type="text/javascript"></script>
<script src="/CESBack/Public/js/surveyManage/surveyPublish.js" type="text/javascript"></script>
</html>