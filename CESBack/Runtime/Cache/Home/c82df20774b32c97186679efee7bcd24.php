...
<head>
    ...
    <link href="/CESBack/Public/assets/font-awesome/css/font-awesome.css" rel="stylesheet"><!-- 字体 CSS -->
    <link href="/CESBack/Public/css/style.css" rel="stylesheet"><!-- 主题 CSS -->
    ...
    <script src="/CESBack/Public/js/index/login.js"></script>
    <!--[if lt IE 9]>
    <script src="/CESBack/Public/js/html5shiv.js"></script>
    <script src="/CESBack/Public/js/respond.min.js"></script>
    <![endif]-->
