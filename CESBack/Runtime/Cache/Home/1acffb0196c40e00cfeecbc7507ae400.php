    ...
    <aside>
        <div id="sidebar" class="nav-collapse">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <!--主菜单-->
                <li>
                    <a href="<?php echo U('Home/Home/home');?>">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li>
                            <a href="<?php echo U('Home/WeChat/setWeChatMenu');?>">
                                公众号菜单设置
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo U('Home/WeChat/messageGroupSend');?>">
                                公众号消息群发
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo U('Home/WeChat/setAutoRes');?>">
                                用户消息回复设置
                            </a>
                        </li>
                        <li class="dis-none">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li>
                            <a href="<?php echo U('Home/WeChat/userManage');?>">
                                用户信息管理
                            </a>
                        </li>
                        <li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li>
                            <a href="<?php echo U('Home/WeChat/courseManage');?>">
                                课程信息管理
                            </a>
                        </li>
                        <li class="active">
                            <a href="<?php echo U('Home/WeChat/surveyManage');?>">
                                评级问卷管理
                            </a>
                        </li>
                        <li>
                                ...
                                <form id="formSearch" class="form-horizontal">
                                    <div class="form-group" style="margin-top:15px">
                                        ...
                                        <label class="control-label col-sm-3" for="txt_search_user_input"
                                               style="margin-left:30px;width:100px">问卷名称：</label>
...
<script src="/CESBack/Public/js/surveyManage/surveyManage.js" type="text/javascript"></script>
