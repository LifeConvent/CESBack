...
//                pageList: [10, 25, 50, 100, ALL],  //可供选择的每页的行数（*）
        ...
        $('#table_record').bootstrapTable({
            url: HOST + "CESBack/index.php/Home/CourseManage/getRecord",   //请求后台的URL（*）
            method: 'get',      //请求方式（*）
...
function deleteRecord() {
    ...
    $.ajax({
        type: "POST", //用POST方式传输
        url: HOST + "CESBack/index.php/Home/CourseManage/deleteRecord", //目标地址.
...
function record_show() {
    ...
    $('#table_record').bootstrapTable('refresh', {url: HOST + "CESBack/index.php/Home/CourseManage/searchRecord" + url});
