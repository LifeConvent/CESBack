...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#table_condition').bootstrapTable({
            url: HOST + "CESBack/index.php/Home/CourseManage/getSurveyPlan",   //请求后台的URL（*）
            method: 'get',      //请求方式（*）
...
function surveyConditionModify() {
    ...
    $.ajax({
        type: "POST", //用POST方式传输
        url: HOST + "CESBack/index.php/Home/courseManage/modifySurveyCondition", //目标地址.
...
function exportExcel() {
    ...
    window.location.href = HOST + "CESBack/index.php/Home/Method/expSurveyCondition?content=" + data;
}
...
function delCondition() {
    ...
    $.ajax({
        type: "POST", //用POST方式传输
        url: HOST + "CESBack/index.php/Home/courseManage/delCondition", //目标地址.
        dataType: "json", //数据格式:JSON
        data: {id: id},
        success: function (result) {
            if (result.status == 'success') {
...
function searchCondition(){
    ...
    $('#table_condition').bootstrapTable('refresh', {url: HOST + "CESBack/index.php/Home/CourseManage/searchCondition" + url});
